...
<script lang="ts">
import Vue, { defineComponent, onMounted, computed, ref } from "vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    // 新增的文本内容可以用markdown写，所以查看的时候也是要显示对应markdown的
    ...
    const hideAndDelete = () => {
      ...
      store
        ...
        .then((rawData: ResponseType<PostProps>) => {
          createMsg("删除成功，2秒后跳转到专栏首页", "success", 2000);
          setTimeout(() => {
